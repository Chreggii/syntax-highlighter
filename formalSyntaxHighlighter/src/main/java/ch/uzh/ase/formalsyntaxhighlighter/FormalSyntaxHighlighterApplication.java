...
/**
 * The Formal Syntax Highlighter Application that uses the provided .jar file and enables enpoints ot be called.
 */
...
public class FormalSyntaxHighlighterApplication {
  ...
  public Map<String, Object> main() {
     ...
     * @param body The source code and type as defined in the main.java.ch.uzh.ase.formalsyntaxhighlighter.PostBody class
