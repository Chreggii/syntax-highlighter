...
with create_app().app_context():
    ...
    response._content = b'[{ "startIndex": 0, "endIndex": 4, "tokenId": 42}, {"startIndex": 5, "endIndex": 7, ' \
                        b'"tokenId": 3}] '
...
with create_app().app_context():
    ...
    response.code = "expired"
    response.error_type = "expired"
    response._content = b'[{"hCodeValue": 9, "startIndex": 0, "endIndex": 4, "tokenId": 42}, {"hCodeValue": 0, ' \
